...
let nagiHeight: CGFloat = 25 //nagiRatio = 20/11
struct playView: View {
    ...
    @State private var whoIsWinner = ["P1 WIN!!! ","P2 WIN!!! ","TIE ",""]
            ...
            HStack(alignment: .center, spacing: 20){
                ...
                ZStack{
                    ...
                    VStack(alignment: .center, spacing: 20){
                        Pill(stone: $stone[13],player: 1)
                        HStack(alignment: .center, spacing: 41){
                            circleArray(stone: $stone,havingStone: $havingStone,isGameover: $isGameover,playerTurn: $playerTurn,winner: $winner)
                            circleArray2(stone: $stone,havingStone: $havingStone,isGameover: $isGameover,playerTurn: $playerTurn,winner: $winner)
                        }
                ...
                Button{
                    ...
                    ZStack{
                        Circle()
                            ...
                            .overlay(
                                Circle()
                                    .stroke(Color(red: 0.051, green: 0.349, blue: 0.718),lineWidth: 3)
                                    .frame(width: 70, height: 70, alignment: /*@START_MENU_TOKEN@*/.center/*@END_MENU_TOKEN@*/)
                                    .opacity(havingStone[19-i] && (playerTurn == 2) ? 1: 0)
...
struct Pill: View {
    @Binding var stone: Int
    var player: Int
    @State private var whichPlayer = ["P1","P2","AI"]
    var body: some View {
        ZStack{
            Capsule()
                .scaleEffect(x: 1, y: 1, anchor: .center)
                .frame(width: 180, height: 70, alignment: .center)
                .foregroundColor(Color(hue: 0.129, saturation: 1.0, brightness: 1.0, opacity: 0.0))
            Text("  \(whichPlayer[player])\nscore")
                .rotationEffect(.degrees(90))
            ForEach(0...stone, id: \.self){ j in
                if(j != 0){
                    if(j%2==0){
                        Image("isaki")
                            .resizable()
                            ...
                            .fixedSize()
                            .frame(width: isakiHeight, height: isakiHeight, alignment: .center)
                            .offset(x: CGFloat.random(in: -60...60), y: CGFloat.random(in: -15...15))
                    }else{
                        Image("nagi")
                            .resizable()
                            .rotationEffect(.degrees(90))
